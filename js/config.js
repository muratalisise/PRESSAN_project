...
(function($) {
    ...
    var themeApp = {
        ...
        theme_carousel: function() {
            ...
            $('.post-type-carousel').addClass('owl-carousel').owlCarousel({
                loop:true,
                dots:false,
                nav: true,
            ...
            $('.client-carousel').addClass('owl-carousel').owlCarousel({
                loop:true,
                dots:false,
                autoplay: true,
                autoplayTimeout: 2500,
            ...
            $('.service-item-carousel').addClass('owl-carousel').owlCarousel({
                loop:true,
                dots:false,
                autoplay: true,
                autoplayTimeout: 2500,
